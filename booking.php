                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            <div class="container-fluid col-lg-12 col-md-12">
                                ...
                                <div class="border bg-light p-3 rounded mb-3" style="margin: 10px;">
                                    ...
                                    <label for="" class="form-label" style="padding-bottom: 5px">Loại phòng: </label> <br>
        ...
        <table class="table shadow table-bordered" id="hotel_room">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button name="booking_room" type="submit" class='btn btn-dark shadow-none mybtn'>ĐẶT PHÒNG NGAY</button>  </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
        </table>  
